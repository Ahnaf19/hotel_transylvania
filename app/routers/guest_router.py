...
# @router.delete("/{guest_id}", response_model=GuestBase, responses={200: {"description": "Guest deleted"}, 404: {"description": "Guest not found"}})
...
#     if guest is None:
#         raise HTTPException(status_code=404, detail="Guest not found")
#     guest_service.guests.remove(guest)
#     return guest
...
#     if guest is None:
#         raise HTTPException(status_code=404, detail="Guest not found")
#     guest.update(**updated_guest.dict(exclude_unset=True))
#     return guest